...
This is the code to accompany the tutorial available in our deployment guide [How to deploy a Django application to production](https://codecapsules.io/docs/deployment/how-to-deploy-django-application-to-production/).
